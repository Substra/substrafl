...
def test_np_index_generator_batch_shuffle(seed, results):
    ...
    nig = NpIndexGenerator(n_samples=3, batch_size=3, shuffle=True, drop_last=True, seed=seed, num_updates=40)
...
def test_np_index_generator_not_batch_shuffle():
    ...
    nig = NpIndexGenerator(n_samples=3, batch_size=3, shuffle=False, drop_last=True, seed=42, num_updates=40)
    res = np.arange(3)
...
def test_np_index_generator_statefulness(session_dir):
    ...
    nig = NpIndexGenerator(n_samples=5, batch_size=3, shuffle=True, drop_last=True, seed=42, num_updates=50)
...
def test_np_index_generator_num_updates():
    ...
    nig = NpIndexGenerator(n_samples=3, batch_size=3, shuffle=True, drop_last=True, seed=10, num_updates=10)
    for _ in range(10):
        next(nig)
...
def test_np_index_generator_reset():
    ...
    num_updates = 10
    nig = NpIndexGenerator(n_samples=3, batch_size=3, shuffle=True, drop_last=True, seed=10, num_updates=num_updates)
...
def test_np_index_generator_torch_dataloader(num_workers):
    ...
    num_updates = 10
    nig = NpIndexGenerator(
        n_samples=n_samples, batch_size=3, shuffle=True, drop_last=True, seed=10, num_updates=num_updates
    )
    nig_copy = NpIndexGenerator(
        n_samples=n_samples, batch_size=3, shuffle=True, drop_last=True, seed=10, num_updates=num_updates
    )
