...
## [0.21.2](https://github.com/owkin/connectlib/releases/tag/0.21.2) - 2022-08-01

- fix: move the RNG state to CPU in case the checkpoint has been loaded on the GPU (#244)
