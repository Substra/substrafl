...
class AggregationNode(Node):
    ...
    def register_operations(
        ...
        Args:
            ...
            cache (Dict[RemoteStruct, OperationKey]): Already registered algorithm identifications. The key of each
                element is the RemoteStruct id (generated by connectlib) and the value is the key generated by substra.
            dependencies (Dependency): Dependencies of the given operation.

        Returns:
            Dict[RemoteStruct, OperationKey]: updated cache
        """
